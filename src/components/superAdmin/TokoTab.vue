      ...
      >
        ...
        <div class="pt-4 border-t border-gray-100 flex gap-2">
          <button
            ...
            class="flex-1 py-2 bg-info bg-opacity-20 text-info-600 rounded-lg hover-bg-info hover:text-white transition text-sm font-medium"
          >
            Ubah
          </button>
          <button
            @click="handleDelete(t.id)"
            class="flex-1 py-2 bg-danger bg-opacity-20 text-danger-600 rounded-lg hover-bg-danger hover:text-white transition text-sm font-medium"
          >
            Hapus
          </button>
        </div>
